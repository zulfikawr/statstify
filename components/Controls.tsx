    ...
    <div className="bg-white/80 backdrop-blur-md p-6 rounded-3xl shadow-xl w-full max-w-[340px] md:max-w-sm mx-auto space-y-6 border border-gray-100/50">
      ...
      <div className="flex bg-gray-100/80 p-1.5 rounded-xl mb-4">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-3 text-xs font-bold rounded-lg transition-all cursor-pointer ${
            config.view === "receipt"
        ...
        <div className="flex bg-gray-100/80 p-1.5 rounded-xl">
          {ranges.map((range) => (
            <button
              ...
              className={`flex-1 py-2 text-[10px] sm:text-xs font-medium rounded-lg transition-all cursor-pointer ${
        ...
        <div className="flex gap-4">
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between bg-gray-100/80 rounded-xl p-1.5">
              <button
                ...
                className="w-8 h-8 flex items-center justify-center bg-white rounded-lg shadow-sm hover:bg-gray-50 active:scale-95 transition text-gray-700 cursor-pointer"
          ...
          <div className="flex-1">
            ...
            <button
              ...
              className={`w-full h-[44px] flex items-center justify-center gap-2 rounded-xl text-xs font-bold transition-all border shadow-sm active:scale-95 cursor-pointer ${
                config.showAlbumArt
        ...
        <div className="flex flex-wrap gap-3 justify-center sm:justify-start">
          {themes.map((t) => (
            <button
              ...
              className={`w-10 h-10 rounded-full border-2 transition-transform hover:scale-110 active:scale-90 cursor-pointer ${
                config.theme === t
        ...
        <div className="flex bg-gray-100/80 p-1.5 rounded-xl">
          {textures.map((t) => (
            <button
              ...
              className={`flex-1 py-2 text-[10px] sm:text-xs font-medium uppercase rounded-lg transition-all cursor-pointer ${
                config.texture === t
                  ? "bg-white text-black shadow-sm ring-1 ring-black/5"
                  : "text-gray-500 hover:text-gray-700"
              }`}
      ...
      <div className="pt-2 space-y-3">
        <div className="flex gap-3">
          <button
            onClick={onDownload}
            className="flex-1 flex items-center justify-center gap-2 py-3.5 bg-zinc-900 text-white rounded-xl font-bold hover:bg-zinc-800 transition-colors active:scale-95 shadow-lg shadow-zinc-200 cursor-pointer"
          >
            <Download className="w-4 h-4" />
            Save Image
          </button>
          <button
            className="px-4 py-3.5 bg-white border border-gray-200 text-gray-600 rounded-xl hover:bg-gray-50 transition-colors active:scale-95 cursor-pointer"
            title="Share (Demo)"
            onClick={() =>
